...
import com.ndourcodeur.ecommercespringapirest.config.JwtUtil;
...
import com.ndourcodeur.ecommercespringapirest.services.CartItemService;
import com.ndourcodeur.ecommercespringapirest.services.JwtUserDetailsService;
import com.ndourcodeur.ecommercespringapirest.services.ProductService;
import com.ndourcodeur.ecommercespringapirest.services.UserService;
...
public class APIController {
    ...
    @PutMapping("/users/{id}")
    public ResponseEntity<?> updateUser (@PathVariable("id") Long id, @RequestBody Map<String, Object> user) {
